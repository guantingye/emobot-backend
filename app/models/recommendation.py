...
class Recommendation(Base):
    ...
    scores: Mapped[dict] = mapped_column(JSONB)         # 各 bot 分數
    top_bot: Mapped[str] = mapped_column(String(32))    # 最高分 bot
    features: Mapped[dict | None] = mapped_column(JSONB, nullable=True)  # 解釋用特徵
